...
export default function LessonPage({ params }) {
  ...
  return (
    <div className="w-full min-h-screen bg-white px-20 py-10">
      ...
      <p className="text-black text-base mb-4">Contenido de la lección:</p>

      <div className="bg-gray-50 text-black p-6 rounded-lg shadow mb-10">
        <LessonRenderer contenido={leccion.contenido} />
      </div>

      {leccion.nombre.includes("origen") && (
        <div className="p-6 flex flex-col bg-white items-center rounded-lg shadow-lg">
